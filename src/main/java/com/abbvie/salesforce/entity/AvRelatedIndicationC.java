...
/**
 * The persistent class for the av_related_indication__c database table.
 * 
 */
@Data	
@Entity
@Table(name="av_related_indication__c")
public class AvRelatedIndicationC implements Serializable {
