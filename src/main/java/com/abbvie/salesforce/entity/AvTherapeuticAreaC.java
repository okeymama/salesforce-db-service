...
/**
 * The persistent class for the av_therapeutic_area__c database table.
 * 
 */
@Data	
@Entity
@Table(name="av_therapeutic_area__c")
public class AvTherapeuticAreaC implements Serializable {
	...
	@Column(name="av_therapeutic_area_description__c")
	private String avTherapeuticAreaDescriptionC;
