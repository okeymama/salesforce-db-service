...
/**
 * The persistent class for the av_role__c database table.
 * 
 */
@Data	
@Entity
@Table(name="av_role__c")	
public class AvRoleC implements Serializable {
	...
	@Column(name="av_role_code__c")
	private String avRoleCodeC;
